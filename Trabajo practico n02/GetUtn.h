 ...
 *
 * \param  EL mensaje que será mostrado al usuario
...
/** \brief Solicita un numero y devuelve el resultado
 *
 * \param m El mensaje que será mostrado al usuario
 * \return Es el numero ingresado.
 */
...
/** \brief Hace mayusculas a  la primer letra del dato ingresado.
 *
 ...
 * \return 1 si es numero y 0 si no lo es .
 */
 ...
 *
 * \param str Array con la cadena que sera analizada.
 * \return 1 si es numero, con espacios y guion y 0 si no lo es.
 */
